...
const zhCN: PrivacyMessages = {
  ...
  hero: {
    eyebrow: "隐私融入设计",
    title: "你的音乐 始终属于你",
    intro: "MusicPod 不设账户、广告或第三方追踪。经你授权后，App 仅通过 MusicKit 访问播放所需内容，不会把资料库或收听记录上传到我们的服务器。",
    updated: "最后更新：2026 年 7 月 17 日",
    version: "版本 1.0",
  },
  principles: [
    { title: "无需账户", body: "无需注册或提供姓名" },
    { title: "无广告追踪", body: "不出售信息，不用于定向广告" },
    { title: "资料库留在 Apple", body: "MusicPod 不保存服务器副本" },
  ],
  contents: "本页内容",
  sections: [
    {
      ...
      title: "1. 适用范围与运营者",
      paragraphs: [
        "本政策适用于 iPhone 版 MusicPod App 与官方网站 musicpod.app，由下方列出的运营者负责。",
        "Apple Music、App Store 等第三方服务适用其各自的隐私条款。",
      ],
    },
    {
      id: "app-data",
      title: "2. App 处理的信息",
      paragraphs: ["获得系统授权后，MusicPod 仅通过 MusicKit 读取展示和播放音乐所需的信息。"],
      items: [
        "歌曲、专辑、艺人、播放列表和封面等资料库信息。",
        "当前内容、队列、播放状态与进度。",
        "Apple Music 授权与订阅状态。",
        "配色、主题和辅助功能等设置，仅保存在设备本地。",
      ],
      note: "MusicPod 不会获取 Apple 账户密码，也不会保存资料库副本或上传收听记录。",
    },
    {
      id: "website-data",
      title: "3. 官网处理的信息",
      paragraphs: ["官网不使用广告像素或第三方分析工具。托管服务仅处理交付网页和保障安全所需的技术信息。"],
      items: [
        "IP 地址、浏览器、设备、访问页面和安全信号等请求日志，由 Vercel 处理。",
        "musicpod_locale Cookie：记录语言选择，最长保留 12 个月。",
        "musicpod-theme 本地值：记录外观选择，可通过“跟随系统”或清除网站数据移除。",
      ],
      note: "App Store 徽章由 Apple 域名加载，显示时浏览器会向 Apple 发出请求。",
    },
    {
      id: "use",
      title: "4. 信息的使用方式与目的",
      paragraphs: [
        "这些信息仅用于提供服务、保存你的选择、保障安全、排查问题和回复咨询。必要时，我们依据履行服务、合法利益、法律义务或你的同意进行处理。Apple Music 权限可随时撤回。",
      ],
    },
    {
      id: "sharing",
      title: "5. 服务提供商与信息披露",
      paragraphs: ["MusicPod 不出售、出租个人信息，也不将其用于定向广告。"],
      items: [
        "Apple 按自身条款处理 Apple Music 请求与播放信息。",
        "Vercel 处理网站流量与技术日志，用于托管和安全防护。",
        "法律要求或保护用户、公众及服务安全时，我们可能依法披露必要信息。",
      ],
      note: "服务提供商只能为其提供的服务处理信息，并须采取相应保护措施。",
      links: [
    ...
    },
    {
      ...
      title: "6. 信息保留与安全",
      paragraphs: [
        "MusicPod 不保存 Apple Music 资料库副本。App 设置留在设备上；网站偏好、托管日志和联系邮件仅按功能、安全或法律需要保留。",
        "我们会采取与所处理信息相称的安全措施，但任何传输或存储方式都无法保证绝对安全。",
      ],
    },
    {
      id: "choices",
      ...
      items: [
        "Apple Music 权限：在 iPhone 设置中查看或撤回。",
        "设备数据：删除 App 可移除本地设置，设备备份除外。",
        "网站偏好：清除 Cookie 与网站数据，或选择“跟随系统”。",
        "法定权利：你可按所在地区的法律请求访问、更正、删除、限制或携带信息，也可反对处理或撤回同意。",
      ],
      note: "MusicPod 不设账户，也不保存资料库，因此我们可能没有可识别你的数据。Apple 控制的信息请通过 Apple 管理。",
    ...
    },
    {
      ...
      title: "8. 未成年人及跨境处理",
      paragraphs: [
        "MusicPod 不会故意收集未成年人的个人信息。如儿童曾直接向我们发送信息，请由父母或监护人联系我们处理。",
        "官网技术信息可能在其他国家或地区处理；必要时由服务提供商提供跨境传输保障。",
      ],
    },
    {
      id: "changes",
      title: "9. 政策更新",
      paragraphs: ["功能、服务提供商或法律要求变化时，我们会更新本页和日期。重大变更将按法律要求另行通知或征求同意。"],
    },
    {
      id: "contact",
      title: "10. 联系我们",
      paragraphs: [
        "如有隐私问题或希望行使权利，请发送邮件并说明需求及所在国家或地区。",
        "请勿发送 Apple 账户密码、验证码或资料库副本；我们不会索取这些信息。",
      ],
    },
  ],
...
const zhTW: PrivacyMessages = {
  ...
  hero: {
    eyebrow: "隱私融入設計",
    title: "你的音樂 始終屬於你",
    intro: "MusicPod 不設帳號、廣告或第三方追蹤。經你授權後，App 僅透過 MusicKit 存取播放所需內容，不會將資料庫或收聽紀錄上傳到我們的伺服器。",
    updated: "最後更新：2026 年 7 月 17 日",
    version: "版本 1.0",
  },
  principles: [
    { title: "無需帳號", body: "無需註冊或提供姓名" },
    { title: "無廣告追蹤", body: "不出售資訊，不用於定向廣告" },
    { title: "資料庫留在 Apple", body: "MusicPod 不保存伺服器副本" },
  ],
  contents: "本頁內容",
  sections: [
    {
      ...
      title: "1. 適用範圍與營運者",
      paragraphs: [
        "本政策適用於 iPhone 版 MusicPod App 與官方網站 musicpod.app，由下方列出的營運者負責。",
        "Apple Music、App Store 等第三方服務適用其各自的隱私條款。",
      ],
    },
    {
      id: "app-data",
      title: "2. App 處理的資訊",
      paragraphs: ["取得系統授權後，MusicPod 僅透過 MusicKit 讀取顯示和播放音樂所需的資訊。"],
      items: [
        "歌曲、專輯、藝人、播放列表和封面等資料庫資訊。",
        "目前內容、佇列、播放狀態與進度。",
        "Apple Music 授權與訂閱狀態。",
        "配色、主題和輔助使用等設定，僅儲存在裝置上。",
      ],
      note: "MusicPod 不會取得 Apple 帳號密碼，也不會保存資料庫副本或上傳收聽紀錄。",
    },
    {
      id: "website-data",
      title: "3. 官網處理的資訊",
      paragraphs: ["官網不使用廣告像素或第三方分析工具。代管服務僅處理提供網頁和維護安全所需的技術資訊。"],
      items: [
        "IP 位址、瀏覽器、裝置、瀏覽頁面和安全訊號等要求記錄，由 Vercel 處理。",
        "musicpod_locale Cookie：記錄語言選擇，最長保留 12 個月。",
        "musicpod-theme 本機值：記錄外觀選擇，可透過「跟隨系統」或清除網站資料移除。",
      ],
      note: "App Store 徽章由 Apple 網域載入，顯示時瀏覽器會向 Apple 發出要求。",
    },
    {
      id: "use",
      title: "4. 資訊的使用方式與目的",
      paragraphs: [
        "這些資訊僅用於提供服務、保存你的選擇、維護安全、排解問題和回覆詢問。必要時，我們依據履行服務、合法利益、法律義務或你的同意進行處理。Apple Music 權限可隨時撤回。",
      ],
    },
    {
      id: "sharing",
      title: "5. 服務供應商與資訊揭露",
      paragraphs: ["MusicPod 不出售、出租個人資訊，也不將其用於定向廣告。"],
      items: [
        "Apple 依自身條款處理 Apple Music 要求與播放資訊。",
        "Vercel 處理網站流量與技術記錄，用於代管和安全防護。",
        "法律要求或保護使用者、公眾及服務安全時，我們可能依法揭露必要資訊。",
      ],
      note: "服務供應商只能為其提供的服務處理資訊，並須採取相應保護措施。",
      links: [
    ...
    },
    {
      ...
      title: "6. 資訊保留與安全",
      paragraphs: [
        "MusicPod 不保存 Apple Music 資料庫副本。App 設定留在裝置上；網站偏好、代管記錄和聯絡郵件僅按功能、安全或法律需要保留。",
        "我們會採取與所處理資訊相稱的安全措施，但任何傳輸或儲存方式都無法保證絕對安全。",
      ],
    },
    {
      id: "choices",
      ...
      items: [
        "Apple Music 權限：在 iPhone 設定中查看或撤回。",
        "裝置資料：移除 App 可刪除本機設定，裝置備份除外。",
        "網站偏好：清除 Cookie 與網站資料，或選擇「跟隨系統」。",
        "法定權利：你可按所在位置的法律要求存取、更正、刪除、限制或攜帶資訊，也可反對處理或撤回同意。",
      ],
      note: "MusicPod 不設帳號，也不保存資料庫，因此我們可能沒有可識別你的資料。Apple 控制的資訊請透過 Apple 管理。",
    ...
    },
    {
      ...
      title: "8. 兒童與國際處理",
      paragraphs: [
        "MusicPod 不會故意收集兒童的個人資訊。如兒童曾直接向我們傳送資訊，請由家長或監護人聯絡我們處理。",
        "官網技術資訊可能在其他國家或地區處理；必要時由服務供應商提供跨境傳輸保障。",
      ],
    },
    {
      id: "changes",
      title: "9. 政策更新",
      paragraphs: ["功能、服務供應商或法律要求改變時，我們會更新本頁和日期。重大變更將按法律要求另行通知或徵求同意。"],
    },
    {
      id: "contact",
      title: "10. 聯絡我們",
      paragraphs: [
        "如有隱私問題或希望行使權利，請寄送電子郵件並說明需求及所在國家或地區。",
        "請勿傳送 Apple 帳號密碼、驗證碼或資料庫副本；我們不會索取這些資訊。",
      ],
    },
  ],
...
const ptBR: PrivacyMessages = {
  ...
  hero: {
    ...
    updated: "Última atualização: 17 de julho de 2026",
    version: "Versão 1.0",
  },
  principles: [
