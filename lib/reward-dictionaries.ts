...
const en: RewardMessages = {
  ...
  metaDescription: "Share your MusicPod experience on Xiaohongshu or X and claim lifetime access.",
  back: "MusicPod home",
  navLabel: "Lifetime reward",
  title: [
    { before: "Share MusicPod on ", accent: "Xiaohongshu or X", after: ".", tone: "share" },
  ...
  pasteHint:
    "Post about your MusicPod experience on Xiaohongshu or X, mention MusicPod in the post, then paste the share text or link here.",
  ...
  invalidLink: "No share link was found. Paste the full share text or link from Xiaohongshu or X.",
  unsupportedPlatform:
    "Only Xiaohongshu and X posts are supported for this campaign. Please share on one of them.",
  contentNotFound:
    "The post could not be opened. Make sure it is public and was not deleted, then try again.",
  contentMismatch:
    "The post does not mention MusicPod. Please include MusicPod in your post and try again.",
...
const zhCN: RewardMessages = {
  ...
  pasteHint:
    "在小红书或 X 发布 MusicPod 使用体验（正文需提到 MusicPod），然后复制分享文案或链接粘贴到这里。",
  ...
  contentMismatch: "分享内容里没有提到 MusicPod，请在正文中提到 MusicPod 后重试。",
...
const zhTW: RewardMessages = {
  ...
  pasteHint:
    "在小紅書或 X 發佈 MusicPod 使用體驗（正文需提到 MusicPod），然後複製分享文案或連結貼到這裡。",
  placeholder: "例如：https://xhslink.com/… 或 https://x.com/…/status/…",
  verify: "驗證並領取",
  verifying: "正在驗證…",
  success: "領取成功",
  ...
  contentMismatch: "分享內容沒有提到 MusicPod，請在正文中提到 MusicPod 後重試。",
...
const translations: Partial<Record<Locale, Partial<RewardMessages>>> = {
  ...
  es: {
    ...
    title: [
      { before: "Comparte MusicPod en ", accent: "Xiaohongshu o X", after: ".", tone: "share" },
    ...
    pasteHint:
      "Publica tu experiencia con MusicPod en Xiaohongshu o X (menciona MusicPod en el texto) y pega aquí el texto o enlace compartido.",
    ...
    contentMismatch: "La publicación no menciona MusicPod. Añádelo al texto e inténtalo de nuevo.",
  ...
  fr: {
    ...
    title: [
      { before: "Partagez MusicPod sur ", accent: "Xiaohongshu ou X", after: ".", tone: "share" },
    ...
    pasteHint:
      "Publiez votre expérience de MusicPod sur Xiaohongshu ou X (mentionnez MusicPod dans le texte), puis collez ici le texte ou le lien de partage.",
    ...
    contentMismatch: "La publication ne mentionne pas MusicPod. Ajoutez-le au texte puis réessayez.",
  ...
  de: {
    ...
    title: [
      { before: "Teile MusicPod auf ", accent: "Xiaohongshu oder X", after: ".", tone: "share" },
    ...
    pasteHint:
      "Veröffentliche deine MusicPod-Erfahrung auf Xiaohongshu oder X (erwähne MusicPod im Text) und füge hier den geteilten Text oder Link ein.",
    ...
    contentMismatch: "Der Beitrag erwähnt MusicPod nicht. Ergänze es im Text und versuche es erneut.",
  ...
  "pt-br": {
    ...
    title: [
      { before: "Compartilhe o MusicPod no ", accent: "Xiaohongshu ou X", after: ".", tone: "share" },
    ...
    pasteHint:
      "Publique sua experiência com o MusicPod no Xiaohongshu ou X (mencione o MusicPod no texto) e cole aqui o texto ou link compartilhado.",
    placeholder: "ex.: https://xhslink.com/… ou https://x.com/…/status/…",
    ...
    contentMismatch: "A publicação não menciona o MusicPod. Adicione ao texto e tente novamente.",
