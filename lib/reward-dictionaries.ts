...
const en: RewardMessages = {
  ...
  successBody: "Copy the code or open the redemption link on your Apple device.",
...
const zhCN: RewardMessages = {
  ...
  analyzing: "正在识别…",
  success: "终身会员兑换码已准备好",
  successBody: "复制兑换码，或直接在 Apple 设备上打开兑换链接。",
  codeLabel: "兑换码",
  copy: "复制",
  copied: "已复制",
  redeem: "兑换终身会员",
...
const zhTW: RewardMessages = {
  ...
  analyzing: "正在辨識…",
  success: "終身會員兌換碼已準備好",
  successBody: "複製兌換碼，或直接在 Apple 裝置上開啟兌換連結。",
  codeLabel: "兌換碼",
  copy: "複製",
  copied: "已複製",
  redeem: "兌換終身會員",
