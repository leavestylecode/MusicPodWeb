...
const en: Messages = {
  ...
  hero: {
    ...
    primaryKicker: "App Store",
    primary: "Coming soon",
    secondary: "Explore MusicPod",
    badges: ["Made for iPhone", "Apple Music", "iOS 26"],
  ...
  personalize: {
    ...
    presets: ["MusicPod Original", "Classic Silver", "nano Blue", "nano Pink"],
...
const zhCN: Messages = {
  ...
  hero: {
    ...
    badges: ["为 iPhone 打造", "Apple Music", "iOS 26"],
  ...
  personalize: { kicker: "属于你的", title: "一台播放器，完全属于你。", body: "自定义机身、转盘、屏幕、背景、方向与光晕。", palette: "12 种真实机身与转盘配色", combinations: "经典配色组合", presets: ["MusicPod 原色", "经典银白", "nano 蓝", "nano 粉"], stats: [{ value: "12", label: "种机身与转盘配色" }, { value: "9", label: "套背景主题" }, { value: "2", label: "套首页图标语言" }] },
...
const zhTW: Messages = {
  ...
  hero: { kicker: "專為 Apple Music 設計", title: ["你的音樂。", "你的 iPod。"], body: "一款為 iPhone 打造的觸感音樂播放器，以點按式轉盤連接你的 Apple Music 資料庫。", primaryKicker: "App Store", primary: "即將推出", secondary: "探索 MusicPod", badges: ["為 iPhone 打造", "Apple Music", "iOS 26"], productLabel: "MusicPod 實際 App 介面", screenshotAlt: "MusicPod 首頁，包含喜愛歌曲、迷你播放器與紅色點按式轉盤", actual: "實際介面", native: "原生 SwiftUI" },
  ...
  personalize: { kicker: "屬於你的", title: "一台播放器，完全屬於你。", body: "自訂機身、轉盤、螢幕、背景、方向與光暈。", palette: "12 種真實機身與轉盤配色", combinations: "經典配色組合", presets: ["MusicPod 原色", "經典銀白", "nano 藍", "nano 粉"], stats: [{ value: "12", label: "種機身與轉盤配色" }, { value: "9", label: "套背景主題" }, { value: "2", label: "套首頁圖示語言" }] },
...
const ja: Messages = {
  ...
  hero: { kicker: "Apple Musicのためにデザイン", title: ["あなたの音楽。", "あなたのiPod。"], body: "クリックホイールとApple Musicライブラリを中心に設計した、iPhoneのための触感的なミュージックプレーヤー。", primaryKicker: "App Store", primary: "近日公開", secondary: "MusicPodを体験", badges: ["iPhoneのために", "Apple Music", "iOS 26"], productLabel: "MusicPodの実際のアプリ画面", screenshotAlt: "お気に入りの曲、ミニプレーヤー、赤いクリックホイールを表示したMusicPodのホーム画面", actual: "実際の画面", native: "SwiftUIネイティブ" },
  ...
  personalize: { kicker: "自分らしく", title: "自分だけの一台に。", body: "本体、ホイール、画面、背景、向き、光まで選べます。", palette: "本体とホイールの12色", combinations: "クラシックな配色", presets: ["MusicPod オリジナル", "クラシックシルバー", "nano ブルー", "nano ピンク"], stats: [{ value: "12", label: "本体とホイールのカラー" }, { value: "9", label: "背景テーマ" }, { value: "2", label: "ホームアイコンの言語" }] },
...
const ko: Messages = {
  ...
  hero: { kicker: "Apple Music을 위해 설계", title: ["내 음악.", "나만의 iPod."], body: "클릭 휠과 Apple Music 보관함을 중심으로 설계한 iPhone용 촉각 음악 플레이어입니다.", primaryKicker: "App Store", primary: "출시 예정", secondary: "MusicPod 살펴보기", badges: ["iPhone을 위해 제작", "Apple Music", "iOS 26"], productLabel: "MusicPod 실제 앱 화면", screenshotAlt: "좋아하는 노래, 미니 플레이어, 빨간색 클릭 휠이 있는 MusicPod 홈 화면", actual: "실제 화면", native: "네이티브 SwiftUI" },
  ...
  personalize: { kicker: "나만의 방식으로", title: "하나의 플레이어. 온전히 나만의 것.", body: "본체, 휠, 화면, 배경, 방향과 빛을 선택하세요.", palette: "본체 및 휠 실제 색상 12개", combinations: "클래식 색상 조합", presets: ["MusicPod 오리지널", "클래식 실버", "nano 블루", "nano 핑크"], stats: [{ value: "12", label: "본체 및 휠 색상" }, { value: "9", label: "배경 테마" }, { value: "2", label: "홈 아이콘 언어" }] },
...
const fr: Messages = {
  ...
  hero: { kicker: "Conçu pour Apple Music", title: ["Votre musique.", "Votre iPod."], body: "Un lecteur de musique tactile pour iPhone, conçu autour de la molette cliquable et de votre bibliothèque Apple Music.", primaryKicker: "App Store", primary: "Bientôt disponible", secondary: "Découvrir MusicPod", badges: ["Conçu pour iPhone", "Apple Music", "iOS 26"], productLabel: "Interface réelle de l’app MusicPod", screenshotAlt: "Écran d’accueil MusicPod avec morceaux favoris, mini-lecteur et molette rouge", actual: "Interface réelle", native: "SwiftUI natif" },
...
const ptBR: Messages = {
  ...
  hero: { kicker: "Criado para Apple Music", title: ["Sua música.", "Seu iPod."], body: "Um player de música tátil para iPhone, criado em torno da click wheel e da sua biblioteca do Apple Music.", primaryKicker: "App Store", primary: "Em breve", secondary: "Conheça o MusicPod", badges: ["Feito para iPhone", "Apple Music", "iOS 26"], productLabel: "Interface real do app MusicPod", screenshotAlt: "Tela inicial do MusicPod com músicas favoritas, miniplayer e click wheel vermelha", actual: "Interface real", native: "SwiftUI nativo" },
  ...
  personalize: { kicker: "Deixe do seu jeito", title: "Um player. Totalmente seu.", body: "Escolha corpo, roda, tela, fundo, direção e brilho.", palette: "12 cores reais de corpo e roda", combinations: "Combinações de cores clássicas", presets: ["MusicPod Original", "Classic prateado", "nano azul", "nano rosa"], stats: [{ value: "12", label: "cores de corpo e roda" }, { value: "9", label: "temas de fundo" }, { value: "2", label: "idiomas de ícones" }] },
