...
const zhCN: Messages = {
  ...
  availability: { kicker: "全球发布", title: "即将登陆 App Store。", body: "MusicPod 正在为全球发布做最后准备。", badgeKicker: "即将登陆", badge: "App Store", requirement: "需要 iOS 26 和有效的 Apple Music 订阅。" },
...
const zhTW: Messages = {
  ...
  hero: { kicker: "專為 Apple Music 設計", title: ["你的音樂。", "你的 iPod。"], body: "一款為 iPhone 打造的觸感音樂播放器，以點按式轉盤連接你的 Apple Music 資料庫。", primaryKicker: "即將登上", primary: "App Store", secondary: "探索 MusicPod", badges: ["為 iPhone 打造", "Apple Music", "iOS 26"], productLabel: "MusicPod 實際 App 介面", screenshotAlt: "MusicPod 首頁，包含喜愛歌曲、迷你播放器與紅色點按式轉盤", actual: "實際介面", native: "原生 SwiftUI" },
  ...
  availability: { kicker: "全球推出", title: "即將登上 App Store。", body: "MusicPod 正為全球推出進行最後準備。", badgeKicker: "即將登上", badge: "App Store", requirement: "需要 iOS 26 與有效的 Apple Music 訂閱。" },
...
const ja: Messages = {
  ...
  availability: { kicker: "世界同時リリース", title: "App Storeに近日登場。", body: "MusicPodは世界リリースに向けて最終準備中です。", badgeKicker: "まもなく登場", badge: "App Store", requirement: "iOS 26と有効なApple Musicサブスクリプションが必要です。" },
  footer: { rights: "All rights reserved." },
};
...
const ko: Messages = {
  ...
  hero: { kicker: "Apple Music을 위해 설계", title: ["내 음악.", "나만의 iPod."], body: "클릭 휠과 Apple Music 보관함을 중심으로 설계한 iPhone용 촉각 음악 플레이어입니다.", primaryKicker: "곧 출시됩니다", primary: "App Store", secondary: "MusicPod 살펴보기", badges: ["iPhone을 위해 제작", "Apple Music", "iOS 26"], productLabel: "MusicPod 실제 앱 화면", screenshotAlt: "좋아하는 노래, 미니 플레이어, 빨간색 클릭 휠이 있는 MusicPod 홈 화면", actual: "실제 화면", native: "네이티브 SwiftUI" },
  ...
  availability: { kicker: "글로벌 출시", title: "App Store 출시 예정.", body: "MusicPod는 전 세계 출시를 위한 마지막 준비 중입니다.", badgeKicker: "곧 출시됩니다", badge: "App Store", requirement: "iOS 26 및 유효한 Apple Music 구독이 필요합니다." },
  footer: { rights: "All rights reserved." },
};
...
const es: Messages = {
  ...
  availability: { kicker: "Lanzamiento mundial", title: "Próximamente en App Store.", body: "MusicPod está ultimando los detalles para su lanzamiento mundial.", badgeKicker: "Próximamente en", badge: "App Store", requirement: "Requiere iOS 26 y una suscripción activa a Apple Music." },
...
const fr: Messages = {
  ...
  hero: { kicker: "Conçu pour Apple Music", title: ["Votre musique.", "Votre iPod."], body: "Un lecteur de musique tactile pour iPhone, conçu autour de la molette cliquable et de votre bibliothèque Apple Music.", primaryKicker: "Bientôt sur", primary: "App Store", secondary: "Découvrir MusicPod", badges: ["Conçu pour iPhone", "Apple Music", "iOS 26"], productLabel: "Interface réelle de l’app MusicPod", screenshotAlt: "Écran d’accueil MusicPod avec morceaux favoris, mini-lecteur et molette rouge", actual: "Interface réelle", native: "SwiftUI natif" },
  ...
  availability: { kicker: "Lancement mondial", title: "Bientôt sur l’App Store.", body: "MusicPod finalise les préparatifs de son lancement mondial.", badgeKicker: "Bientôt sur", badge: "App Store", requirement: "Nécessite iOS 26 et un abonnement Apple Music actif." },
...
const de: Messages = {
  ...
  availability: { kicker: "Weltweiter Start", title: "Demnächst im App Store.", body: "MusicPod befindet sich in der letzten Vorbereitung für den weltweiten Start.", badgeKicker: "Demnächst im", badge: "App Store", requirement: "Erfordert iOS 26 und ein aktives Apple Music-Abonnement." },
...
const ptBR: Messages = {
  ...
  availability: { kicker: "Lançamento mundial", title: "Em breve na App Store.", body: "O MusicPod está nos preparativos finais para o lançamento mundial.", badgeKicker: "Em breve na", badge: "App Store", requirement: "Requer iOS 26 e uma assinatura ativa do Apple Music." },
