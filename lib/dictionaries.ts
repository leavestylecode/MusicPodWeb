...
export type Messages = {
  ...
  footer: { rights: string; privacy: string; developer: string };
};
...
const en: Messages = {
  ...
  availability: {
    ...
    body: "MusicPod is now available on the App Store.",
    badgeKicker: "Download on the",
    badge: "App Store",
    requirement: "Compatible with iOS 17 or later · Apple Music subscription required.",
  },
  footer: { rights: "All rights reserved.", privacy: "Privacy Policy", developer: "An independent product by" },
};

const zhCN: Messages = {
  meta: { title: "MusicPod — 你的音乐，你的 iPod", description: "为 iPhone 打造的触感音乐播放器，用点按式转盘浏览 Apple Music 资料库。", social: "转动、点按、聆听，为 Apple Music 重新想象 iPod。" },
  skip: "跳到主要内容",
  ...
  hero: {
    ...
    title: ["你的音乐", "你的 iPod"],
    body: "为 iPhone 打造的触感播放器，用点按式转盘浏览 Apple Music",
    primaryKicker: "下载自",
    primary: "App Store",
  ...
  mantra: { label: "MusicPod 的三个动作", eyebrow: "熟悉的动作 全新的体验", words: ["点按", "转动", "聆听"] },
  wheel: {
...
const zhTW: Messages = {
  meta: { title: "MusicPod — 你的音樂，你的 iPod", description: "為 iPhone 打造的觸感音樂播放器，用點按式轉盤瀏覽 Apple Music 資料庫。", social: "轉動、點按、聆聽，為 Apple Music 重新想像 iPod。" },
  skip: "跳到主要內容",
  ...
  hero: { kicker: "專為 Apple Music 設計", title: ["你的音樂", "你的 iPod"], body: "為 iPhone 打造的觸感播放器，用點按式轉盤瀏覽 Apple Music", primaryKicker: "下載自", primary: "App Store", secondary: "探索 MusicPod", badges: ["為 iPhone 打造", "Apple Music", "iOS 17+"], productLabel: "MusicPod 實際 App 介面", screenshotAlt: "MusicPod 首頁，包含喜愛歌曲、迷你播放器與紅色點按式轉盤", actual: "實際介面", native: "原生 SwiftUI" },
...
const ko: Messages = {
  ...
  hero: { kicker: "Apple Music을 위해 설계", title: ["내 음악.", "나만의 iPod."], body: "클릭 휠과 Apple Music 보관함을 중심으로 설계한 iPhone용 촉각 음악 플레이어입니다.", primaryKicker: "App Store에서 다운로드", primary: "App Store", secondary: "MusicPod 살펴보기", badges: ["iPhone을 위해 제작", "Apple Music", "iOS 17+"], productLabel: "MusicPod 실제 앱 화면", screenshotAlt: "좋아하는 노래, 미니 플레이어, 빨간색 클릭 휠이 있는 MusicPod 홈 화면", actual: "실제 화면", native: "네이티브 SwiftUI" },
...
const fr: Messages = {
  ...
  hero: { kicker: "Conçu pour Apple Music", title: ["Votre musique.", "Votre iPod."], body: "Un lecteur de musique tactile pour iPhone, conçu autour de la molette cliquable et de votre bibliothèque Apple Music.", primaryKicker: "Télécharger dans", primary: "App Store", secondary: "Découvrir MusicPod", badges: ["Conçu pour iPhone", "Apple Music", "iOS 17+"], productLabel: "Interface réelle de l’app MusicPod", screenshotAlt: "Écran d’accueil MusicPod avec morceaux favoris, mini-lecteur et molette rouge", actual: "Interface réelle", native: "SwiftUI natif" },
